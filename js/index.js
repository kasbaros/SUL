...
var App = React.createClass({
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(TitleList, { title: 'Top Book picks for Luca Skywalker', url: '' }),
			React.createElement(TitleList, { title: 'Trending now', url: 'discover/movie?sort_by=popularity.desc&page=1' }),
			React.createElement(TitleList, { title: 'Most Viewed in Classics', url: 'genre/27/movies?sort_by=popularity.desc&page=1' }),
			React.createElement(TitleList, { title: 'Sci-Fi greats', url: 'genre/878/movies?sort_by=popularity.desc&page=1' }),
			React.createElement(TitleList, { title: 'Fun magic', url: 'genre/35/movies?sort_by=popularity.desc&page=1' })
		);
	}
});
...
var Search = React.createClass({
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement('input', { type: 'search', placeholder: 'Search for a Book title...' })
		);
	}
});
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'image' },
					React.createElement('img', { src: 'img/starwars.jpg' })
				)
			),
			React.createElement(
				'div',
...
var Hero = React.createClass({
	...
	render: function render() {
		return React.createElement(
			'div',
			{ id: 'hero', className: 'Hero', style: { backgroundImage: 'url(img/background.jpg)' } },
			React.createElement(
				'div',
				{ className: 'content' },
...
Help iVanilla save enough money to buy a new bike and go rescue Plato! Learn about how to save money by completing the 4 next stories.'
				...
				React.createElement(
					...
					React.createElement(HeroButton, { primary: true, text: 'Read now' }),
